...
function (x, \ldots)
\{
the\_call \textless- match.call()
the\_call{[}{[}1{]}{]} \textless- as.name(``mean\_'')
if (inherits(x, c(``Matrix'', ``sparseMatrix'', ``sparseVector'')))
return(Matrix::mean(x, \ldots))
return(eval(the\_call, parent.frame()))
\}
\textless bytecode: 0x11c28c960\textgreater{}
\textless environment: namespace:mosaic\textgreater{}
function (x, \ldots, data = NULL, groups = NULL, na.rm = getOption(``na.rm'',
FALSE))
\{
if (rlang::is\_formula(x)) \{
if (is.null(data))
data \textless- environment(x)
formula \textless- mosaicCore::mosaic\_formula\_q(x, groups = !!rlang::enexpr(groups),
max.slots = 3)
return(maggregate(formula, data = data, FUN = stats::sd,
\ldots, na.rm = na.rm, .multiple = FALSE))
\}
stats::sd(x, \ldots, na.rm = na.rm)
\}
\textless bytecode: 0x11c5737c0\textgreater{}
\textless environment: namespace:mosaic\textgreater{}

\hypertarget{participants}{%
\subsection{Participants}\label{participants}}

Collected over a four-year period, the present sample consists of 156 incarcerated females exhibiting varying levels of psychopathic and borderline tendencies. Participants range in age, from 20 to 53 (M = \emph{reference}, SD = \emph{reference}). Participants were randomly selected and subsequently informed of the nature of the study. Before screening, they were required to provide consent. Random selection was used to allow for a wide array of scores that could be systematically examined across the various facets of targeted measures.
...
\includegraphics{d2m-Psychopathy_files/figure-latex/ugly-plots-1.pdf}
...
## ACME              0.263        0.102         0.45   0.004 ** 
## ADE               0.111       -0.155         0.35   0.368    
## Total Effect      0.373        0.200         0.52  <2e-16 ***
## Prop. Mediated    0.704        0.256         1.61   0.004 ** 
## ---
...
\includegraphics{d2m-Psychopathy_files/figure-latex/ugly-plots-2.pdf}
...
## 
##                Estimate 95% CI Lower 95% CI Upper p-value    
## ACME             0.3214       0.1335         0.49  <2e-16 ***
## ADE              0.0962      -0.1435         0.34     0.4    
## Total Effect     0.4176       0.2278         0.59  <2e-16 ***
## Prop. Mediated   0.7696       0.3131         1.54  <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Sample Size Used: 104 
...
\includegraphics{d2m-Psychopathy_files/figure-latex/ugly-plots-3.pdf}
...
## 
##                Estimate 95% CI Lower 95% CI Upper p-value   
## ACME             0.2551       0.1073         0.44   0.004 **
## ADE              0.0362      -0.2151         0.26   0.756   
## Total Effect     0.2914       0.1130         0.48   0.004 **
## Prop. Mediated   0.8756       0.2984         2.55   0.008 **
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Sample Size Used: 104 
...
## 
##                Estimate 95% CI Lower 95% CI Upper p-value  
## ACME             0.0433      -0.1072         0.20    0.60  
## ADE              0.1542      -0.0878         0.38    0.19  
## Total Effect     0.1975       0.0302         0.36    0.02 *
## Prop. Mediated   0.2192      -0.7403         1.96    0.61  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Sample Size Used: 104 
...
There is a significant relationship between predictor and outcome (\emph{p} = 0.00). However, this effect goes away when adding BPD as a mediator (\emph{p} = ). This suggests that the presence of BPD acts as a mechanism through which the predictor influences the outcome. The significant, full mediation effect we observed suggests that a portion of the total effect of the predictor on the outcome is explained by the mediator (\emph{p} = ).
...
Bagby, R. M., Taylor, G. J., \& Parker, J. D. A. (1994). The twenty-item {Toronto Alexithymia} scale{\textemdash}{II}. {Convergent}, discriminant, and concurrent validity. \emph{Journal of Psychosomatic Research}, \emph{38}(1), 33--40. \url{https://doi.org/10.1016/0022-3999(94)90006-X}
