...
<!--
two descriptive analyses i am doing are correlation tests to determine the relationship of (1) predictor and outcome, and (2) predictor and mediator prior to running a regression. this is necessary in order to proceed with a mediation analysis.
-->
